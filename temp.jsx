...
const ScalingWordComponent = () => {
  ...
  return (
    <section ref={triggerRef}  style={{ backgroundImage: "url(/ZaavG.jpeg)" }} className="bg-cover overflow-hidden bg-center relative h-screen flex items-center justify-start">
